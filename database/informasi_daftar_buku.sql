...
--
-- Database: `informasi_daftar_buku`
--
...
--
-- Struktur dari tabel `informasi_bukus`
--

CREATE TABLE `informasi_bukus` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `waktu_buat` timestamp NOT NULL DEFAULT '2021-10-07 02:37:08',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `informasi_bukus`
--
...
--
-- Struktur dari tabel `informasi_penulis`
--

CREATE TABLE `informasi_penulis` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data untuk tabel `informasi_penulis`
--

INSERT INTO `informasi_penulis` (`id`, `nama_penulis`, `created_at`, `updated_at`) VALUES
(1, 'Sulthan Rafif', NULL, NULL),
(2, 'Andra Akmal Maulidani', NULL, NULL),
(3, 'Mellano Trias Mahendra', NULL, NULL),
(4, 'Asep Bensin', NULL, NULL);
...
(6, '2021_10_06_090456_create_informasi_bukus_table', 1),
(7, '2021_10_06_092301_create_informasi_penulis_table', 1);
...
(1, 'Admin', 'admin@mail.com', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, 'drBF1xybBGZJkOHt66y9tFQUCxqWWbxGNRPgB2yperzfEgFYemram7bnXA3j', '2021-10-07 02:37:09', '2021-10-07 02:37:09');
...
--
-- Indeks untuk tabel `informasi_bukus`
--
ALTER TABLE `informasi_bukus`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `informasi_penulis`
--
ALTER TABLE `informasi_penulis`
  ADD PRIMARY KEY (`id`);
